...
| `emscripten-websocket-demo` | `emscripten-websocket-demo` | Browser WebSocket client path backed by `emscripten_websocket_socket.cpp`. |
...
browser client that uses `WebSocketConfig` and `CreateWebSocketClient`.

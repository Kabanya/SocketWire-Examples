...
| `math-duel` | `math-duel-server`, `math-duel-client` | [server.cpp](math-duel/server.cpp), [server.hpp](math-duel/server.hpp), [client.cpp](math-duel/client.cpp), [client.hpp](math-duel/client.hpp) | Console multiplayer flow. |
| `packet-stream` | `packet-stream-server`, `packet-stream-client` | [server.cpp](packet-stream/server.cpp), [client.cpp](packet-stream/client.cpp) | Reliable connection packet stream. |
